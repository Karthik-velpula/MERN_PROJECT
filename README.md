# AURA EVENTS - Full Stack Event Management Application

> "Aura is not just a name, it's a promise"
...
### 3. Database Setup
1. Create a MySQL database named `aura_events`
...
For support and queries, please contact the AURA EVENTS team.

---

**AURA EVENTS** - Where every event becomes an unforgettable experience! ✨